...
export default function ApiFetchPage() {
  ...
  const [fetchProgress, setFetchProgress] = useState<{ current: number; total: number; percentage: number } | null>(null);
            ...
            <div className="mt-4 space-y-2">
              <div className="flex items-center justify-between text-sm">
                <span className="text-muted-foreground">
                  {fetchProgress.current} / {fetchProgress.total} entries
                </span>
                <span className="font-semibold gradient-text">{fetchProgress.percentage}%</span>
              </div>
