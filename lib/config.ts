...
export const config = configSchema.parse({
  ...
  projectRepoUrl: process.env.PROJECT_REPO_URL || "https://github.com",
  developerName: process.env.DEVELOPER_NAME || "Developer",
  developerBio: process.env.DEVELOPER_BIO || "Full Stack Developer",
  developerGithub: process.env.DEVELOPER_GITHUB || "https://github.com",
  developerLinkedin: process.env.DEVELOPER_LINKEDIN || "https://linkedin.com",
